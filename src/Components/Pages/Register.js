    ...
    return (
        <>
            ...
            <div className="animate__animated animate__fadeInRightBig animate__faster">
                <div className={`pt-[25px] pb-[29px] mb-[12px] relative ${style.RegTop}`}>
                    <img src={iconback} alt="" onClick={handleBack} className='absolute top-0 bottom-0 my-auto left-[6.4vw]' />
                    <p className="w-full text-center font-medium text-[24px] leading-[28px] text-[#232440]">Registration</p>
                </div>
                <div className="px-[5.86vw] pb-[27px]">
                    <form autoComplete='off' onSubmit={handleRegister}>
                        <div className="relative mb-[28px]">
                            <label htmlFor="username" className="text-[14px] leading-[20px] text-[#6e6e82] mb-[8px]">Username</label><br />
                        ...
                        <div className="relative mb-[28px]">
                            <label htmlFor="company" className="text-[14px] leading-[20px] text-[#6e6e82] mb-[8px]">Company Name</label><br />
                        ...
                        <div className="mb-[28px]">
                            <label htmlFor="company-type" className="text-[14px] leading-[20px] text-[#6e6e82] mb-[8px]">Company Type</label><br />
                        ...
                        <div className="relative mb-[28px]">
                            <label htmlFor="email" className="text-[14px] leading-[20px] text-[#6e6e82] mb-[8px]">Email Address</label><br />
                        ...
                        <div className="relative mb-[28px]">
                            <label htmlFor="contact-person" className="text-[14px] leading-[20px] text-[#6e6e82] mb-[8px]">Contact Person</label><br />
                        ...
                        <div className="relative mb-[28px]">
                            <label htmlFor="phone" className="text-[14px] leading-[20px] text-[#6e6e82] mb-[8px]">Phone</label><br />
                        ...
                        <button className={`${style.Register} w-full mb-[21px]`} type='submit'>Register</button>
                    </form>
                    <p className="text-[16px] leading-6 text-center text-[#232440]">Already have account ? <span className='text-[#665AF0] cursor-pointer' onClick={handleNavigate}>Login</span></p>
                </div>
            </div>
        </>
    );
